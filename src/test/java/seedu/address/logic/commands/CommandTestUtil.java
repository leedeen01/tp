...
public class CommandTestUtil {
    ...
    public static final String INVALID_PREMIUM_DESC = " " + PREFIX_PREMIUM + " asd " + -9999; // negative premium not allowed
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withPremiumList(VALID_PREMIUM_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withPremiumList(VALID_PREMIUM_BOB).build();
    }
